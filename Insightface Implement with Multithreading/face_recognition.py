...
if __name__ == "__main__":
    ...
    if choice == "1":
        camera_source = 1 # Webcam
    elif choice == "2":
        camera_source = "rtsp://rndteam:rnddev1234%@192.168.6.76/media/video1"  # RTSP URL
    else:
    ...
    try:
        ...
        app.prepare(ctx_id=-1, det_size=(640, 640))  # Use CPU with ctx_id=-1
