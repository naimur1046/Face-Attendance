...
# Start video capture from the CCTV RTSP stream
cctv_rtsp_url = "rtsp://rndteam:rnddev123@192.168.6.75:554/Streaming/Channels/101?transportmode=unicast&profile=Profile_1"
...
while True:
    ...
    # Display the frame
    cv2.imshow('CCTV Video Stream', resized_frame)
